    ...
    <div id="root-container">
        ...
        <div id="left-side">
            <header>
              ...
              <p>
                Guess the word within 8 attempts to help Team India score 300+ runs!
              </p>
              <p>
                Each correct guess adds 51 runs to the total score and wrong guess means one wicket goes away.

              </p>
              <p>HINT:- 99% of the words contain atleast one vowel(may contain more). So, start guessing with E(my guess).</p>
            </header>
            <ControlPanel
        ...
        {!isGameOver && (<section className="about">
            <p>Play and Grow!
            This game helps sharpen your vocabulary, improve focus, and boost mental agility.
            Enjoy the thrill of guessing while learning new words in a fun, competitive setting.
            Perfect for quick brain workouts and word lovers of all ages!</p>
        </section>)}
        <section
          aria-live="polite"
          role="status"
